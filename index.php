...
<body class="bg-slate-50 text-slate-900 selection:bg-blue-100">
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 md:py-28 flex flex-col md:flex-row items-center gap-16 overflow-hidden">
        <div class="flex-1 space-y-8">
            <h1 class="hero-font text-[clamp(2.5rem,11vw,3rem)] md:text-7xl leading-tight">
                Drink to your heart and track it with <span class="brand-font font-bold marker-highlight decoration-4 underline-offset-8">HydroTracker</span>
            </h1>
            <p class="text-xl text-slate-500 leading-relaxed max-w-lg">
                Turn your daily water intake into a challenge. Empty the bottle, track your stats, and stay healthy with HydroTracker.
            </p>
        ...
        <div class="flex-1 relative w-full max-w-sm md:max-w-none mx-auto mt-12 md:mt-0">
            <div class="w-full aspect-square bg-white border-2 border-slate-100 rounded-[2rem] md:rounded-[3rem] hero-pattern relative overflow-hidden shadow-2xl shadow-blue-100 transform rotate-2">
                
                <div class="floating-icon absolute bottom-4 right-4 md:bottom-8 md:right-8 w-24 h-24 md:w-40 md:h-40 bg-blue-500 rounded-2xl md:rounded-3xl flex items-center justify-center shadow-2xl border-4 md:border-8 border-white">

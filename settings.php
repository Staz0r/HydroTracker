...
<body class="bg-blue-50 min-h-screen pb-20">
    ...
    <div class="max-w-2xl mx-auto p-6 mt-6">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="actions/logout.php" class="bg-red-50 text-red-500 px-4 py-2 rounded-lg text-sm font-bold hover:bg-red-100 transition">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <select name="reminder" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 font-bold focus:outline-none focus:border-blue-500 appearance-none cursor-pointer">
                            <option value="30" <?php echo ($user['reminder_frequency'] == 30) ? 'selected' : ''; ?>>30 Minutes</option>
                            <option value="60" <?php echo ($user['reminder_frequency'] == 60) ? 'selected' : ''; ?>>1 Hour</option>
                            <option value="120" <?php echo ($user['reminder_frequency'] == 120) ? 'selected' : ''; ?>>2 Hours</option>
                            <option value="180" <?php echo ($user['reminder_frequency'] == 180) ? 'selected' : ''; ?>>3 Hours</option>
                        </select>
                ...
                <div class="mb-2">
                    ...
                    <div class="flex gap-4">
                        <input type="number" name="daily_goal" id="daily_goal" required 
                            ...
                            class="grow bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 font-bold focus:outline-none focus:border-blue-500 text-xl">
                        
                        <button type="button" onclick="recalculateGoal()" 
                            class="shrink-0 px-4 py-2 bg-blue-50 text-blue-600 font-bold rounded-xl hover:bg-blue-100 transition text-sm">

...
<body class="min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="flex border-b border-gray-100">
            <button onclick="switchTab('login')" id="tab-login" class="flex-1 py-4 text-sm font-bold text-blue-600 border-b-2 border-blue-600 bg-blue-50/50 transition">
                LOGIN
            </button>
            <button onclick="switchTab('register')" id="tab-register" class="flex-1 py-4 text-sm font-bold text-gray-400 hover:text-blue-500 transition">
                REGISTER
            </button>
        </div>
        ...
        <div id="view-login" class="p-8">
            ...
            <?php if (isset($_GET['success'])): ?>
                <div class="mb-4 p-3 bg-green-100 text-green-700 rounded-lg text-sm text-center">Account created! Please log in.</div>
            <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" 
                               class="w-full pl-10 pr-3 py-3 border rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition <?php echo isset($_SESSION['errors']['login_email']) ? 'border-red-500' : 'border-gray-200'; ?>" 
                               placeholder="you@example.com" 
                               value="<?php echo isset($_SESSION['old']['login_email']) ? htmlspecialchars($_SESSION['old']['login_email']) : ''; ?>">
                    </div>
                    <span class="text-xs text-red-500"><?php echo $_SESSION['errors']['login_email'] ?? ''; ?></span>
                </div>
            ...
            <form action="<?php echo BASE_URL; ?>/actions/auth_process.php" method="POST" class="space-y-4">
                ...
                <div class="mt-4">
                    <div class="flex items-center gap-3 max-w-sm mx-auto">
                        <input type="checkbox" name="terms" value="1" class="w-4 h-4 text-blue-600 rounded cursor-pointer shrink-0">
                        <span class="text-xs text-gray-500 text-left">
                            ...
                            and <a href="#" class="text-blue-500 font-bold hover:underline">Privacy Policy</a> set by HydroTracker.
                        </span>
                    </div>
                ...
                <button type="submit" class="w-full bg-green-500 text-white font-bold py-3 rounded-xl hover:bg-green-600 transition shadow-lg shadow-green-200">
                    CREATE ACCOUNT
                </button>
            </form>
        </div>

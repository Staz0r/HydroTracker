...
<body class="bg-blue-50 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto p-6 mt-6">
        ...
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-sm mb-4 text-blue-500">
                <i class="fa-solid fa-droplet text-3xl animate-bounce"></i>
            </div>
            <h1 class="text-3xl font-bold text-slate-800 brand-font">About <span class="text-blue-600">HydroTracker</span></h1>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden mb-8">
            <div class="p-8">
                ...
                <p class="text-slate-600 leading-relaxed">
                    ...
                    <strong>Global Leaderboard</strong>, we help users reach their daily goals in a fun and interactive way.
                </p>
            </div>
        </div>
...
<div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden mb-8">
            <div class="p-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    ...
                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 hover:bg-indigo-50 transition-colors cursor-help" 
                         title="PHP: Hypertext Preprocessor - Handles all server-side logic and authentication.">
                        <i class="fa-brands fa-php text-3xl text-indigo-500 mb-2"></i>
                        <p class="text-xs font-bold text-slate-600 uppercase">Backend</p>
                    </div>

                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 hover:bg-orange-50 transition-colors cursor-help" 
                         title="MySQL: Relational Database - Stores user data, logs, and settings.">
                    ...
                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 hover:bg-cyan-50 transition-colors cursor-help" 
                         title="Tailwind CSS: Utility-First Framework - Used for rapid UI development and responsive design.">
                        <i class="fa-solid fa-wind text-3xl text-cyan-500 mb-2"></i>
                        <p class="text-xs font-bold text-slate-600 uppercase">Tailwind</p>
                    </div>

                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 hover:bg-yellow-50 transition-colors cursor-help" 
                         title="JavaScript: Client-Side Logic - Handles dynamic updates, modals, and goal calculations.">
